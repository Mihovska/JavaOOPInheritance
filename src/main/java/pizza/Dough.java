...
public class Dough {
  private static final double WHITE_DEFAULT_CALORIES = 1.5;
  private static final double WHOLEGRAIN_DEFAULT_CALORIES = 1.0;
  private static final double CRISPY_DEFAULT_CALORIES = 0.9;
  private static final double CHEWY_DEFAULT_CALORIES = 1.1;
  private static final double HOMEMADE_DEFAULT_CALORIES = 1.0;
